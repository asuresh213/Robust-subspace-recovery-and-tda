...
Download and run `demo.py` to reproduce the results listed above. Note: For illustration purposes, the $\texttt{num_pure}$ variable in `demo.py` should always be a perfect squre number.
